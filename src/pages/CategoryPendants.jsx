...
<section className="category-hero category-hero--has-bg category-hero--pendants category-hero--necklace" style={{ backgroundImage: "url('images/necklace-header.png')" }}></section>
